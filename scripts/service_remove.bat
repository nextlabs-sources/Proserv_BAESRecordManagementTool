...
set "SELF=%~dp0%service_install.bat"
set scriptdir=%~dp0%
set PARENT=%~dp0%..
...
set SERVICE_NAME=RMT
set DISPLAYNAME=Record Management Service %SERVICE_NAME%
...
if "x%1x" == "x--userx" goto runAsUser
set SERVICE_NAME=%1
set DISPLAYNAME=Record Management Service %1
shift
if "x%1x" == "xx" goto checkServiceCmd
goto checkUser
:runAsUser
...
"%EXECUTABLE%" //IS//%SERVICE_NAME% ^
    --Description "Apache Tomcat 7.0.57 Server - http://tomcat.apache.org/" ^
